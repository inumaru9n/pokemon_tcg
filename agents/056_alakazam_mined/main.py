...
RULE_M2 = _flag052("M2")  # EXP-056マイニング: 攻撃準備済み+手札4-6でBasic Psychic手貼り温存
...
try:
    ...
    _p056 = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                         "attack_table_056.py")
...
if os.environ.get("F055_VALUE", "on") != "off":
    try:
        ...
        _v_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                               "value_055.npz")
