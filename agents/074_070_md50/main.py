...
# ロード順: lightgbm+model_074.txt（ローカル高速）→ model_074.npz（純Python、Kaggle用。
...
if os.environ.get("F057_ML", "on") != "off":
    try:
        ...
        try:
            ...
            _mp = os.path.join(_dir057, "model_074.txt")
            ...
            _z = _np057.load(os.path.join(_dir057, "model_074.npz"))
