...
デッキ: agents/098_spidops_gen/deck.csv
ポケモン 6種 / 進化ライン 5本 / エネ 3種 / スタジアム 1種
行動クラス 77個
...
# ---- 自デッキから導出した定数 ----
SPECIES = (400, 401, 414, 431, 432, 463)
SPECIES_NAME = {400: 'tarountula', 401: 'spidops', 414: 'articuno', 431: 'mewtwo', 432: 'wobbuffet', 463: 'murkrow'}
LINE_OF = {400: 'tarountula', 401: 'tarountula', 414: 'articuno', 431: 'mewtwo', 432: 'wobbuffet', 463: 'murkrow'}        # cardId -> 進化ライン名（最下段の種の名前）
LINE_NAMES = ('articuno', 'mewtwo', 'murkrow', 'tarountula', 'wobbuffet')
PRE_EVO = (400,)        # 同デッキ内に進化先を持つ種
ENERGY_NAME = {1: 'basic_g_en', 5: 'basic_p_en', 15: 'energy'}      # 全エネ（基本+特殊）の cardId -> 短縮名
BASIC_ENERGY_NAME = {1: 'basic_g_en', 5: 'basic_p_en'}
TOOL_NAME = {1159: 'cape', 1175: 'brave_bang'}     # ポケモンに付けるツール（ATTACHで来る）
STADIUM_NAME = {1257: 'factory'}
ATTACH_BUCKET = {400: 'tarountula_p', 401: 'tarountula_f', 414: 'articuno_f', 431: 'mewtwo_f', 432: 'wobbuffet_f', 463: 'murkrow_f'}   # エネ貼り先の種 -> クラス分類のバケット
CLS_PLAY = {400: 'play_tarountula', 401: 'play_spidops', 414: 'play_articuno', 431: 'play_mewtwo', 432: 'play_wobbuffet', 463: 'play_murkrow', 1094: 'use_bug_catchi', 1097: 'use_night_stre', 1119: 'use_energy_sea', 1134: 'use_transceive', 1152: 'use_poké_pad', 1159: 'use_cape', 1175: 'use_brave_bang', 1216: 'use_ariana', 1217: 'use_archer', 1218: 'use_giovanni', 1219: 'use_petrel', 1220: 'use_proton', 1227: 'use_determinat', 1257: 'use_factory'}
CLS_EVO = {401: 'evo_spidops'}
CLS_AB = {400: 'ab_tarountula', 401: 'ab_spidops', 414: 'ab_articuno', 431: 'ab_mewtwo', 432: 'ab_wobbuffet', 463: 'ab_murkrow', 1257: 'ab_factory'}        # ポケモンの特性 + 効果を持つスタジアム
CLS_ATK = {559: 'atk_tarountula_0', 560: 'atk_spidops_0', 583: 'atk_articuno_0', 608: 'atk_mewtwo_0', 609: 'atk_wobbuffet_0', 610: 'atk_wobbuffet_1', 652: 'atk_murkrow_0', 653: 'atk_murkrow_1'}      # attackId -> クラス名（技の打ち分け）
CLASSES = ('ab_articuno', 'ab_factory', 'ab_mewtwo', 'ab_murkrow', 'ab_other', 'ab_spidops', 'ab_stadium', 'ab_tarountula', 'ab_wobbuffet', 'atk_articuno_0', 'atk_mewtwo_0', 'atk_murkrow_0', 'atk_murkrow_1', 'atk_other', 'atk_spidops_0', 'atk_tarountula_0', 'atk_wobbuffet_0', 'atk_wobbuffet_1', 'attach_basic_g_en_articuno_f', 'attach_basic_g_en_mewtwo_f', 'attach_basic_g_en_murkrow_f', 'attach_basic_g_en_oth', 'attach_basic_g_en_tarountula_f', 'attach_basic_g_en_tarountula_p', 'attach_basic_g_en_wobbuffet_f', 'attach_basic_p_en_articuno_f', 'attach_basic_p_en_mewtwo_f', 'attach_basic_p_en_murkrow_f', 'attach_basic_p_en_oth', 'attach_basic_p_en_tarountula_f', 'attach_basic_p_en_tarountula_p', 'attach_basic_p_en_wobbuffet_f', 'attach_brave_bang_articuno_f', 'attach_brave_bang_mewtwo_f', 'attach_brave_bang_murkrow_f', 'attach_brave_bang_oth', 'attach_brave_bang_tarountula_f', 'attach_brave_bang_tarountula_p', 'attach_brave_bang_wobbuffet_f', 'attach_cape_articuno_f', 'attach_cape_mewtwo_f', 'attach_cape_murkrow_f', 'attach_cape_oth', 'attach_cape_tarountula_f', 'attach_cape_tarountula_p', 'attach_cape_wobbuffet_f', 'attach_energy_articuno_f', 'attach_energy_mewtwo_f', 'attach_energy_murkrow_f', 'attach_energy_oth', 'attach_energy_tarountula_f', 'attach_energy_tarountula_p', 'attach_energy_wobbuffet_f', 'end', 'evo_spidops', 'other', 'play_articuno', 'play_mewtwo', 'play_murkrow', 'play_spidops', 'play_tarountula', 'play_wobbuffet', 'retreat', 'use_archer', 'use_ariana', 'use_brave_bang', 'use_bug_catchi', 'use_cape', 'use_determinat', 'use_energy_sea', 'use_factory', 'use_giovanni', 'use_night_stre', 'use_petrel', 'use_poké_pad', 'use_proton', 'use_transceive')
