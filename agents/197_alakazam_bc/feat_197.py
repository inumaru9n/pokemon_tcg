...
デッキ: agents/197_alakazam_bc/deck.csv
ポケモン 6種 / 進化ライン 3本 / エネ 3種 / スタジアム 1種
行動クラス 58個
...
FEAT_GROUPS = {'misc', 'threat2', 'megaprize', 'selctx', 'resource', 'slot_attr', 'oppseen', 'base'}

# **このデッキの教師データで算出した削除列**（完全重複の余剰 + 定数列）。
# tools/calc_drop_cols.py が出力する JSON を --drop で渡して焼き込む。
DROP_COLS = ['act_abra', 'act_alakazam', 'act_cant', 'act_dmg', 'act_dudunsparce', 'act_dunsparce', 'act_e', 'act_fezandipiti', 'act_fresh', 'act_hp_ratio', 'act_kadabra', 'act_n_tool', 'dis_13', 'emax_dudunsparce', 'emax_dunsparce', 'emax_fezandipiti', 'hand_1264', 'hand_13', 'hand_n_tool', 'left_1079', 'left_1081', 'left_1086', 'left_1097', 'left_1129', 'left_1152', 'left_1182', 'left_1184', 'left_1225', 'left_1231', 'left_1264', 'left_13', 'left_140', 'left_19', 'left_305', 'left_5', 'left_66', 'left_741', 'left_742', 'left_743', 'me_asleep', 'me_burned', 'me_dot_ability', 'me_paralyzed', 'me_poisoned', 'ms0_tool', 'ms1_tool', 'ms2_tool', 'ms3_tool', 'ms4_tool', 'ms5_tool', 'my_act_prize', 'my_has_protect', 'n_deck_me', 'n_deck_op', 'n_fezandipiti', 'op_asleep', 'op_burned', 'op_confused', 'op_dot_ability', 'op_paralyzed', 'op_poisoned', 'op_retreat_cost', 'opp_act_dmg', 'opp_act_energy', 'opp_act_maxdmg', 'opp_act_prize', 'opp_best_dmg_next', 'opp_cant', 'opp_seen_1118', 'opp_seen_1119', 'opp_seen_1123', 'opp_seen_1127', 'opp_seen_1134', 'opp_seen_1137', 'opp_seen_1147', 'opp_seen_117', 'opp_seen_1173', 'opp_seen_1175', 'opp_seen_1194', 'opp_seen_1201', 'opp_seen_1203', 'opp_seen_1216', 'opp_seen_1218', 'opp_seen_1220', 'opp_seen_1221', 'opp_seen_1223', 'opp_seen_1245', 'opp_seen_1246', 'opp_seen_1251', 'opp_seen_1257', 'opp_seen_1261', 'opp_seen_15', 'opp_seen_20', 'opp_seen_341', 'opp_seen_342', 'opp_seen_343', 'opp_seen_379', 'opp_seen_380', 'opp_seen_381', 'opp_seen_387', 'opp_seen_400', 'opp_seen_401', 'opp_seen_431', 'opp_seen_434', 'opp_seen_89', 'opp_seen_90', 'opp_seen_92', 'os0_i_am_weak_to_it', 'os0_resist_vs_me', 'os0_weak_vs_me', 'os1_resist_vs_me', 'os2_resist_vs_me', 'os3_resist_vs_me', 'os4_resist_vs_me', 'os5_resist_vs_me', 'prz_if_my_act_ko', 'prz_if_opp_act_ko']
...
# ---- 自デッキから導出した定数 ----
SPECIES = (66, 140, 305, 741, 742, 743)
SPECIES_NAME = {66: 'dudunsparce', 140: 'fezandipiti', 305: 'dunsparce', 741: 'abra', 742: 'kadabra', 743: 'alakazam'}
LINE_OF = {66: 'dunsparce', 140: 'fezandipiti', 305: 'dunsparce', 741: 'abra', 742: 'abra', 743: 'abra'}        # cardId -> 進化ライン名（最下段の種の名前）
LINE_NAMES = ('abra', 'dunsparce', 'fezandipiti')
...
STADIUM_NAME = {1264: 'battle_cag'}
ATTACH_BUCKET = {66: 'dunsparce_f', 140: 'fezandipiti_f', 305: 'dunsparce_p', 741: 'abra_p', 742: 'abra_p', 743: 'abra_f'}   # エネ貼り先の種 -> クラス分類のバケット
CLS_PLAY = {66: 'play_dudunsparce', 140: 'play_fezandipiti', 305: 'play_dunsparce', 741: 'play_abra', 742: 'play_kadabra', 743: 'play_alakazam', 1079: 'use_rare_candy', 1081: 'use_enhanced_h', 1086: 'use_buddy_budd', 1097: 'use_night_stre', 1129: 'use_sacred_ash', 1152: 'use_poké_pad', 1182: 'use_orders', 1184: 'use_aid', 1225: 'use_hilda', 1231: 'use_dawn', 1264: 'use_battle_cag'}
CLS_EVO = {66: 'evo_dudunsparce', 742: 'evo_kadabra', 743: 'evo_alakazam'}
CLS_AB = {66: 'ab_dudunsparce', 140: 'ab_fezandipiti', 305: 'ab_dunsparce', 741: 'ab_abra', 742: 'ab_kadabra', 743: 'ab_alakazam', 1264: 'ab_battle_cag'}        # ポケモンの特性 + 効果を持つスタジアム
CLS_ATK = {76: 'atk_dudunsparce_0', 183: 'atk_fezandipiti_0', 423: 'atk_dunsparce_0', 424: 'atk_dunsparce_1', 1070: 'atk_abra_0', 1071: 'atk_kadabra_0', 1072: 'atk_alakazam_0'}      # attackId -> クラス名（技の打ち分け）
CLASSES = ('ab_abra', 'ab_alakazam', 'ab_battle_cag', 'ab_dudunsparce', 'ab_dunsparce', 'ab_fezandipiti', 'ab_kadabra', 'ab_other', 'ab_stadium', 'atk_abra_0', 'atk_alakazam_0', 'atk_dudunsparce_0', 'atk_dunsparce_0', 'atk_dunsparce_1', 'atk_fezandipiti_0', 'atk_kadabra_0', 'atk_other', 'attach_basic_p_en_abra_f', 'attach_basic_p_en_abra_p', 'attach_basic_p_en_dunsparce_f', 'attach_basic_p_en_dunsparce_p', 'attach_basic_p_en_fezandipiti_f', 'attach_basic_p_en_oth', 'attach_enriching__abra_f', 'attach_enriching__abra_p', 'attach_enriching__dunsparce_f', 'attach_enriching__dunsparce_p', 'attach_enriching__fezandipiti_f', 'attach_enriching__oth', 'attach_telepath_p_abra_f', 'attach_telepath_p_abra_p', 'attach_telepath_p_dunsparce_f', 'attach_telepath_p_dunsparce_p', 'attach_telepath_p_fezandipiti_f', 'attach_telepath_p_oth', 'end', 'evo_alakazam', 'evo_dudunsparce', 'evo_kadabra', 'other', 'play_abra', 'play_alakazam', 'play_dudunsparce', 'play_dunsparce', 'play_fezandipiti', 'play_kadabra', 'retreat', 'use_aid', 'use_battle_cag', 'use_buddy_budd', 'use_dawn', 'use_enhanced_h', 'use_hilda', 'use_night_stre', 'use_orders', 'use_poké_pad', 'use_rare_candy', 'use_sacred_ash')
