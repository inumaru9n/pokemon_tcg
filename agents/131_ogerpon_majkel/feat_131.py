...
デッキ: agents/131_ogerpon_majkel/deck.csv
ポケモン 1種 / 進化ライン 1本 / エネ 2種 / スタジアム 1種
行動クラス 31個
...
FEAT_GROUPS = {'base', 'slot_attr', 'threat2', 'misc', 'resource', 'selctx', 'optcond'}
...
# ---- 自デッキから導出した定数 ----
SPECIES = (96,)
SPECIES_NAME = {96: 'teal_mask_og'}
LINE_OF = {96: 'teal_mask_og'}        # cardId -> 進化ライン名（最下段の種の名前）
LINE_NAMES = ('teal_mask_og',)
PRE_EVO = ()        # 同デッキ内に進化先を持つ種
ENERGY_NAME = {1: 'basic_g_en', 18: 'grow_grass'}      # 全エネ（基本+特殊）の cardId -> 短縮名
BASIC_ENERGY_NAME = {1: 'basic_g_en'}
TOOL_NAME = {1159: 'cape'}     # ポケモンに付けるツール（ATTACHで来る）
STADIUM_NAME = {1251: 'lively_sta'}
ATTACH_BUCKET = {96: 'teal_mask_og_f'}   # エネ貼り先の種 -> クラス分類のバケット
CLS_PLAY = {96: 'play_teal_mask_og', 1094: 'use_bug_catchi', 1118: 'use_energy_ret', 1119: 'use_energy_sea', 1122: 'use_pokégear_3', 1127: 'use_tera_orb', 1137: 'use_tool_scrap', 1147: 'use_jumbo_ice_', 1159: 'use_cape', 1182: 'use_orders', 1201: 'use_briar', 1213: 'use_judge', 1221: 'use_plan', 1223: 'use_harlequin', 1227: 'use_determinat', 1251: 'use_lively_sta'}
CLS_EVO = {}
CLS_AB = {96: 'ab_teal_mask_og', 1251: 'ab_lively_sta'}        # ポケモンの特性 + 効果を持つスタジアム
CLS_ATK = {120: 'atk_teal_mask_og_0'}      # attackId -> クラス名（技の打ち分け）
CLASSES = ('ab_lively_sta', 'ab_other', 'ab_stadium', 'ab_teal_mask_og', 'atk_other', 'atk_teal_mask_og_0', 'attach_basic_g_en_oth', 'attach_basic_g_en_teal_mask_og_f', 'attach_cape_oth', 'attach_cape_teal_mask_og_f', 'attach_grow_grass_oth', 'attach_grow_grass_teal_mask_og_f', 'end', 'other', 'play_teal_mask_og', 'retreat', 'use_briar', 'use_bug_catchi', 'use_cape', 'use_determinat', 'use_energy_ret', 'use_energy_sea', 'use_harlequin', 'use_judge', 'use_jumbo_ice_', 'use_lively_sta', 'use_orders', 'use_plan', 'use_pokégear_3', 'use_tera_orb', 'use_tool_scrap')
