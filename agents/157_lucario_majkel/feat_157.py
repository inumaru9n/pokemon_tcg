...
デッキ: agents/157_lucario_majkel/deck.csv
ポケモン 6種 / 進化ライン 4本 / エネ 1種 / スタジアム 0種
行動クラス 52個
...
FEAT_GROUPS = {'selctx', 'misc', 'optcond', 'base', 'resource', 'slot_attr', 'threat2'}
...
# ---- 自デッキから導出した定数 ----
SPECIES = (673, 674, 675, 676, 677, 678)
SPECIES_NAME = {673: 'makuhita', 674: 'hariyama', 675: 'lunatone', 676: 'solrock', 677: 'riolu', 678: 'mega_lucario'}
LINE_OF = {673: 'makuhita', 674: 'makuhita', 675: 'lunatone', 676: 'solrock', 677: 'riolu', 678: 'riolu'}        # cardId -> 進化ライン名（最下段の種の名前）
LINE_NAMES = ('lunatone', 'makuhita', 'riolu', 'solrock')
PRE_EVO = (673, 677)        # 同デッキ内に進化先を持つ種
ENERGY_NAME = {6: 'basic_f_en'}      # 全エネ（基本+特殊）の cardId -> 短縮名
BASIC_ENERGY_NAME = {6: 'basic_f_en'}
TOOL_NAME = {1159: 'cape'}     # ポケモンに付けるツール（ATTACHで来る）
STADIUM_NAME = {}
ATTACH_BUCKET = {673: 'makuhita_p', 674: 'makuhita_f', 675: 'lunatone_f', 676: 'solrock_f', 677: 'riolu_p', 678: 'riolu_f'}   # エネ貼り先の種 -> クラス分類のバケット
CLS_PLAY = {673: 'play_makuhita', 674: 'play_hariyama', 675: 'play_lunatone', 676: 'play_solrock', 677: 'play_riolu', 678: 'play_mega_lucario', 1121: 'use_ultra_ball', 1123: 'use_switch', 1141: 'use_premium_po', 1142: 'use_fighting_g', 1152: 'use_poké_pad', 1159: 'use_cape', 1182: 'use_orders', 1213: 'use_judge', 1227: 'use_determinat', 1229: 'use_compassion'}
CLS_EVO = {674: 'evo_hariyama', 678: 'evo_mega_lucario'}
CLS_AB = {673: 'ab_makuhita', 674: 'ab_hariyama', 675: 'ab_lunatone', 676: 'ab_solrock', 677: 'ab_riolu', 678: 'ab_mega_lucario'}        # ポケモンの特性 + 効果を持つスタジアム
CLS_ATK = {976: 'atk_makuhita_0', 977: 'atk_makuhita_1', 978: 'atk_hariyama_0', 979: 'atk_lunatone_0', 980: 'atk_solrock_0', 981: 'atk_riolu_0', 982: 'atk_mega_lucario_0', 983: 'atk_mega_lucario_1'}      # attackId -> クラス名（技の打ち分け）
CLASSES = ('ab_hariyama', 'ab_lunatone', 'ab_makuhita', 'ab_mega_lucario', 'ab_other', 'ab_riolu', 'ab_solrock', 'ab_stadium', 'atk_hariyama_0', 'atk_lunatone_0', 'atk_makuhita_0', 'atk_makuhita_1', 'atk_mega_lucario_0', 'atk_mega_lucario_1', 'atk_other', 'atk_riolu_0', 'atk_solrock_0', 'attach_basic_f_en_lunatone_f', 'attach_basic_f_en_makuhita_f', 'attach_basic_f_en_makuhita_p', 'attach_basic_f_en_oth', 'attach_basic_f_en_riolu_f', 'attach_basic_f_en_riolu_p', 'attach_basic_f_en_solrock_f', 'attach_cape_lunatone_f', 'attach_cape_makuhita_f', 'attach_cape_makuhita_p', 'attach_cape_oth', 'attach_cape_riolu_f', 'attach_cape_riolu_p', 'attach_cape_solrock_f', 'end', 'evo_hariyama', 'evo_mega_lucario', 'other', 'play_hariyama', 'play_lunatone', 'play_makuhita', 'play_mega_lucario', 'play_riolu', 'play_solrock', 'retreat', 'use_cape', 'use_compassion', 'use_determinat', 'use_fighting_g', 'use_judge', 'use_orders', 'use_poké_pad', 'use_premium_po', 'use_switch', 'use_ultra_ball')
