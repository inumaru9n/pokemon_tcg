...
デッキ: agents/130_lopunny_majkel/deck.csv
ポケモン 5種 / 進化ライン 3本 / エネ 3種 / スタジアム 0種
行動クラス 60個
...
FEAT_GROUPS = {'threat2', 'optcond', 'selctx', 'slot_attr', 'base', 'misc', 'resource'}
...
# ---- 自デッキから導出した定数 ----
SPECIES = (66, 174, 305, 848, 849)
SPECIES_NAME = {66: 'dudunsparce', 174: 'fan_rotom', 305: 'dunsparce', 848: 'buneary', 849: 'mega_lopunny'}
LINE_OF = {66: 'dunsparce', 174: 'fan_rotom', 305: 'dunsparce', 848: 'buneary', 849: 'buneary'}        # cardId -> 進化ライン名（最下段の種の名前）
LINE_NAMES = ('buneary', 'dunsparce', 'fan_rotom')
PRE_EVO = (305, 848)        # 同デッキ内に進化先を持つ種
ENERGY_NAME = {11: 'mist_energ', 13: 'enriching_', 14: 'spiky_ener'}      # 全エネ（基本+特殊）の cardId -> 短縮名
BASIC_ENERGY_NAME = {}
TOOL_NAME = {1174: 'air_balloo'}     # ポケモンに付けるツール（ATTACHで来る）
STADIUM_NAME = {}
ATTACH_BUCKET = {66: 'dunsparce_f', 174: 'fan_rotom_f', 305: 'dunsparce_p', 848: 'buneary_p', 849: 'buneary_f'}   # エネ貼り先の種 -> クラス分類のバケット
CLS_PLAY = {66: 'play_dudunsparce', 174: 'play_fan_rotom', 305: 'play_dunsparce', 848: 'play_buneary', 849: 'play_mega_lopunny', 1086: 'use_buddy_budd', 1121: 'use_ultra_ball', 1122: 'use_pokégear_3', 1152: 'use_poké_pad', 1174: 'use_air_balloo', 1182: 'use_orders', 1197: 'use_machinatio', 1225: 'use_hilda', 1227: 'use_determinat', 1229: 'use_compassion'}
CLS_EVO = {66: 'evo_dudunsparce', 849: 'evo_mega_lopunny'}
CLS_AB = {66: 'ab_dudunsparce', 174: 'ab_fan_rotom', 305: 'ab_dunsparce', 848: 'ab_buneary', 849: 'ab_mega_lopunny'}        # ポケモンの特性 + 効果を持つスタジアム
CLS_ATK = {76: 'atk_dudunsparce_0', 230: 'atk_fan_rotom_0', 423: 'atk_dunsparce_0', 424: 'atk_dunsparce_1', 1223: 'atk_buneary_0', 1224: 'atk_buneary_1', 1225: 'atk_mega_lopunny_0', 1226: 'atk_mega_lopunny_1'}      # attackId -> クラス名（技の打ち分け）
CLASSES = ('ab_buneary', 'ab_dudunsparce', 'ab_dunsparce', 'ab_fan_rotom', 'ab_mega_lopunny', 'ab_other', 'ab_stadium', 'atk_buneary_0', 'atk_buneary_1', 'atk_dudunsparce_0', 'atk_dunsparce_0', 'atk_dunsparce_1', 'atk_fan_rotom_0', 'atk_mega_lopunny_0', 'atk_mega_lopunny_1', 'atk_other', 'attach_air_balloo_buneary_f', 'attach_air_balloo_buneary_p', 'attach_air_balloo_dunsparce_f', 'attach_air_balloo_dunsparce_p', 'attach_air_balloo_fan_rotom_f', 'attach_air_balloo_oth', 'attach_enriching__buneary_f', 'attach_enriching__buneary_p', 'attach_enriching__dunsparce_f', 'attach_enriching__dunsparce_p', 'attach_enriching__fan_rotom_f', 'attach_enriching__oth', 'attach_mist_energ_buneary_f', 'attach_mist_energ_buneary_p', 'attach_mist_energ_dunsparce_f', 'attach_mist_energ_dunsparce_p', 'attach_mist_energ_fan_rotom_f', 'attach_mist_energ_oth', 'attach_spiky_ener_buneary_f', 'attach_spiky_ener_buneary_p', 'attach_spiky_ener_dunsparce_f', 'attach_spiky_ener_dunsparce_p', 'attach_spiky_ener_fan_rotom_f', 'attach_spiky_ener_oth', 'end', 'evo_dudunsparce', 'evo_mega_lopunny', 'other', 'play_buneary', 'play_dudunsparce', 'play_dunsparce', 'play_fan_rotom', 'play_mega_lopunny', 'retreat', 'use_air_balloo', 'use_buddy_budd', 'use_compassion', 'use_determinat', 'use_hilda', 'use_machinatio', 'use_orders', 'use_poké_pad', 'use_pokégear_3', 'use_ultra_ball')
