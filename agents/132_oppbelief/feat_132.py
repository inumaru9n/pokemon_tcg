...
デッキ: agents/132_oppbelief/deck.csv
ポケモン 6種 / 進化ライン 3本 / エネ 3種 / スタジアム 0種
行動クラス 57個
...
FEAT_GROUPS = {'slot_attr', 'optcond', 'resource', 'threat2', 'selctx', 'misc', 'base'}
...
CLASSES = ('ab_abra', 'ab_alakazam', 'ab_dudunsparce', 'ab_dunsparce', 'ab_fezandipiti', 'ab_kadabra', 'ab_other', 'ab_stadium', 'atk_abra_0', 'atk_alakazam_0', 'atk_dudunsparce_0', 'atk_dunsparce_0', 'atk_dunsparce_1', 'atk_fezandipiti_0', 'atk_kadabra_0', 'atk_other', 'attach_basic_p_en_abra_f', 'attach_basic_p_en_abra_p', 'attach_basic_p_en_dunsparce_f', 'attach_basic_p_en_dunsparce_p', 'attach_basic_p_en_fezandipiti_f', 'attach_basic_p_en_oth', 'attach_enriching__abra_f', 'attach_enriching__abra_p', 'attach_enriching__dunsparce_f', 'attach_enriching__dunsparce_p', 'attach_enriching__fezandipiti_f', 'attach_enriching__oth', 'attach_telepath_p_abra_f', 'attach_telepath_p_abra_p', 'attach_telepath_p_dunsparce_f', 'attach_telepath_p_dunsparce_p', 'attach_telepath_p_fezandipiti_f', 'attach_telepath_p_oth', 'end', 'evo_alakazam', 'evo_dudunsparce', 'evo_kadabra', 'other', 'play_abra', 'play_alakazam', 'play_dudunsparce', 'play_dunsparce', 'play_fezandipiti', 'play_kadabra', 'retreat', 'use_aid', 'use_buddy_budd', 'use_dawn', 'use_enhanced_h', 'use_hilda', 'use_machinatio', 'use_night_stre', 'use_orders', 'use_poké_pad', 'use_rare_candy', 'use_sacred_ash')
