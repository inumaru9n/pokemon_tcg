...
usage:
  uv run python agents/059_alakazam_discard/train_discard_059.py \
      --dev dev.pkl --val val.pkl --save model_discard_059
"""
...
AGENT_DIR = os.path.join(REPO_ROOT, "agents/059_alakazam_discard")
