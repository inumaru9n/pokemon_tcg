...
デッキ: agents/186_alakazam_v8/deck.csv
...
FEAT_GROUPS = {'slot_attr', 'misc', 'selctx', 'megaprize', 'threat2', 'base', 'oppseen', 'resource'}

# **このデッキの教師データで算出した削除列**（完全重複の余剰 + 定数列）。
# tools/calc_drop_cols.py が出力する JSON を --drop で渡して焼き込む。
DROP_COLS = ['act_abra', 'act_alakazam', 'act_cant', 'act_dmg', 'act_dudunsparce', 'act_dunsparce', 'act_e', 'act_fezandipiti', 'act_fresh', 'act_hp_ratio', 'act_kadabra', 'act_n_tool', 'act_shaymin', 'dis_13', 'emax_fezandipiti', 'emax_shaymin', 'hand_1266', 'hand_13', 'hand_n_tool', 'left_1079', 'left_1081', 'left_1086', 'left_1097', 'left_1129', 'left_1152', 'left_1182', 'left_1184', 'left_1197', 'left_1225', 'left_1231', 'left_1266', 'left_13', 'left_140', 'left_19', 'left_305', 'left_343', 'left_5', 'left_66', 'left_741', 'left_742', 'left_743', 'me_asleep', 'me_burned', 'me_dot_ability', 'me_paralyzed', 'me_poisoned', 'ms0_tool', 'ms1_tool', 'ms2_tool', 'ms3_tool', 'ms4_tool', 'ms5_tool', 'my_act_prize', 'my_has_protect', 'n_deck_me', 'n_deck_op', 'n_fezandipiti', 'n_shaymin', 'op_asleep', 'op_burned', 'op_confused', 'op_paralyzed', 'op_retreat_cost', 'opp_act_dmg', 'opp_act_energy', 'opp_act_maxdmg', 'opp_act_prize', 'opp_best_dmg_next', 'opp_cant', 'opp_seen_1118', 'opp_seen_117', 'opp_seen_1194', 'opp_seen_1201', 'opp_seen_1221', 'opp_seen_1246', 'os0_i_am_weak_to_it', 'os0_resist_vs_me', 'os0_weak_vs_me', 'os3_resist_vs_me', 'os4_resist_vs_me', 'prz_if_my_act_ko', 'prz_if_opp_act_ko']
...
# **186（教師のデッキ）のキーを保ったまま値だけ 117 のものに差し替える**（EXP-108/120）。
# deck.csv から動的に作ると 0枚のカード（Shaymin 343 / Nighttime Mine 1266）が
# キーごと消え、left_/pool_ 等の特徴キーが縮んでモデルと不一致になる。
