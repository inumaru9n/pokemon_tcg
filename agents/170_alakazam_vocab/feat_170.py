...
デッキ: agents/170_alakazam_vocab/deck.csv
...
# **META_CARDS は教師データでの観測平均で選定**（EXP-122）。
# メタシェアで選ぶと「流行っているが教師が対戦していない」カードが入り、
# 死に次元になって他の特徴の学習を薄める（166: +33枚中18枚が死に、**-2.29pt**）。
# 基準: 104/165 の board_mu のいずれかが 0.02 以上。85枚中 73枚が該当。
# 生成し直す場合は tools/gen_meta_cards.py ではなくこの基準で選ぶこと。
META_CARDS = [2, 6, 11, 13, 14, 15, 18, 19, 20, 66, 89, 92, 93, 96, 104, 112, 119, 120, 121, 174, 235, 305, 341, 342, 343, 344, 345, 379, 380, 381, 387, 400, 401, 414, 431, 434, 646, 647, 648, 741, 742, 743, 756, 848, 849, 860, 1071, 1079, 1081, 1119, 1120, 1123, 1129, 1134, 1142, 1147, 1173, 1174, 1175, 1184, 1198, 1213, 1216, 1217, 1218, 1219, 1220, 1229, 1257, 1259, 1261, 1264, 1266]
...
FEAT_GROUPS = {'threat2', 'oppseen', 'base', 'selctx', 'resource', 'misc', 'optcond', 'slot_attr'}
