"""035_starmie_replica — Mega Starmie ex, reverse-engineered from LB1300+ individual
sig 491b8bfb26 (Yushin Ito, 290 games, 61% overall).

Implements the 30 judgment rules extracted in knowledge/study/starmie_491_study.md
on top of the islet skeleton (AttackPlan + option scoring).

Rule coverage is annotated as R1..R30 in the code.
"""
...
def agent(obs_dict: dict) -> list[int]:
    ...
    return StarmiePolicy(obs).choose()
