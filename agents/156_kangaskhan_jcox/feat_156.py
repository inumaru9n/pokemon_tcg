...
デッキ: agents/156_kangaskhan_jcox/deck.csv
ポケモン 9種 / 進化ライン 9本 / エネ 5種 / スタジアム 1種
行動クラス 96個
...
FEAT_GROUPS = {'threat2', 'slot_attr', 'optcond', 'base', 'misc', 'resource', 'selctx'}
...
# ---- 自デッキから導出した定数 ----
SPECIES = (63, 96, 108, 140, 184, 272, 756, 978, 1071)
SPECIES_NAME = {63: 'raging_bolt', 96: 'teal_mask_og', 108: 'wellspring_m', 140: 'fezandipiti', 184: 'latias', 272: 'clefairy', 756: 'mega_kangask', 978: 'passimian', 1071: 'meowth'}
LINE_OF = {63: 'raging_bolt', 96: 'teal_mask_og', 108: 'wellspring_m', 140: 'fezandipiti', 184: 'latias', 272: 'clefairy', 756: 'mega_kangask', 978: 'passimian', 1071: 'meowth'}        # cardId -> 進化ライン名（最下段の種の名前）
LINE_NAMES = ('clefairy', 'fezandipiti', 'latias', 'mega_kangask', 'meowth', 'passimian', 'raging_bolt', 'teal_mask_og', 'wellspring_m')
PRE_EVO = ()        # 同デッキ内に進化先を持つ種
ENERGY_NAME = {1: 'basic_g_en', 3: 'basic_w_en', 4: 'basic_l_en', 5: 'basic_p_en', 6: 'basic_f_en'}      # 全エネ（基本+特殊）の cardId -> 短縮名
BASIC_ENERGY_NAME = {1: 'basic_g_en', 3: 'basic_w_en', 4: 'basic_l_en', 5: 'basic_p_en', 6: 'basic_f_en'}
TOOL_NAME = {}     # ポケモンに付けるツール（ATTACHで来る）
STADIUM_NAME = {1250: 'area_zero_'}
ATTACH_BUCKET = {63: 'raging_bolt_f', 96: 'teal_mask_og_f', 108: 'wellspring_m_f', 140: 'fezandipiti_f', 184: 'latias_f', 272: 'clefairy_f', 756: 'mega_kangask_f', 978: 'passimian_f', 1071: 'meowth_f'}   # エネ貼り先の種 -> クラス分類のバケット
CLS_PLAY = {63: 'play_raging_bolt', 96: 'play_teal_mask_og', 108: 'play_wellspring_m', 140: 'play_fezandipiti', 184: 'play_latias', 272: 'play_clefairy', 756: 'play_mega_kangask', 978: 'play_passimian', 1071: 'play_meowth', 1088: 'use_prime_catc', 1097: 'use_night_stre', 1098: 'use_glass_trum', 1116: 'use_energy_swi', 1121: 'use_ultra_ball', 1182: 'use_orders', 1197: 'use_machinatio', 1198: 'use_crispin', 1205: 'use_cyrano', 1250: 'use_area_zero_'}
CLS_EVO = {}
CLS_AB = {63: 'ab_raging_bolt', 96: 'ab_teal_mask_og', 108: 'ab_wellspring_m', 140: 'ab_fezandipiti', 184: 'ab_latias', 272: 'ab_clefairy', 756: 'ab_mega_kangask', 978: 'ab_passimian', 1071: 'ab_meowth', 1250: 'ab_area_zero_'}        # ポケモンの特性 + 効果を持つスタジアム
CLS_ATK = {71: 'atk_raging_bolt_0', 72: 'atk_raging_bolt_1', 120: 'atk_teal_mask_og_0', 135: 'atk_wellspring_m_0', 136: 'atk_wellspring_m_1', 183: 'atk_fezandipiti_0', 243: 'atk_latias_0', 371: 'atk_clefairy_0', 1092: 'atk_mega_kangask_0', 1407: 'atk_passimian_0', 1546: 'atk_meowth_0'}      # attackId -> クラス名（技の打ち分け）
CLASSES = ('ab_area_zero_', 'ab_clefairy', 'ab_fezandipiti', 'ab_latias', 'ab_mega_kangask', 'ab_meowth', 'ab_other', 'ab_passimian', 'ab_raging_bolt', 'ab_stadium', 'ab_teal_mask_og', 'ab_wellspring_m', 'atk_clefairy_0', 'atk_fezandipiti_0', 'atk_latias_0', 'atk_mega_kangask_0', 'atk_meowth_0', 'atk_other', 'atk_passimian_0', 'atk_raging_bolt_0', 'atk_raging_bolt_1', 'atk_teal_mask_og_0', 'atk_wellspring_m_0', 'atk_wellspring_m_1', 'attach_basic_f_en_clefairy_f', 'attach_basic_f_en_fezandipiti_f', 'attach_basic_f_en_latias_f', 'attach_basic_f_en_mega_kangask_f', 'attach_basic_f_en_meowth_f', 'attach_basic_f_en_oth', 'attach_basic_f_en_passimian_f', 'attach_basic_f_en_raging_bolt_f', 'attach_basic_f_en_teal_mask_og_f', 'attach_basic_f_en_wellspring_m_f', 'attach_basic_g_en_clefairy_f', 'attach_basic_g_en_fezandipiti_f', 'attach_basic_g_en_latias_f', 'attach_basic_g_en_mega_kangask_f', 'attach_basic_g_en_meowth_f', 'attach_basic_g_en_oth', 'attach_basic_g_en_passimian_f', 'attach_basic_g_en_raging_bolt_f', 'attach_basic_g_en_teal_mask_og_f', 'attach_basic_g_en_wellspring_m_f', 'attach_basic_l_en_clefairy_f', 'attach_basic_l_en_fezandipiti_f', 'attach_basic_l_en_latias_f', 'attach_basic_l_en_mega_kangask_f', 'attach_basic_l_en_meowth_f', 'attach_basic_l_en_oth', 'attach_basic_l_en_passimian_f', 'attach_basic_l_en_raging_bolt_f', 'attach_basic_l_en_teal_mask_og_f', 'attach_basic_l_en_wellspring_m_f', 'attach_basic_p_en_clefairy_f', 'attach_basic_p_en_fezandipiti_f', 'attach_basic_p_en_latias_f', 'attach_basic_p_en_mega_kangask_f', 'attach_basic_p_en_meowth_f', 'attach_basic_p_en_oth', 'attach_basic_p_en_passimian_f', 'attach_basic_p_en_raging_bolt_f', 'attach_basic_p_en_teal_mask_og_f', 'attach_basic_p_en_wellspring_m_f', 'attach_basic_w_en_clefairy_f', 'attach_basic_w_en_fezandipiti_f', 'attach_basic_w_en_latias_f', 'attach_basic_w_en_mega_kangask_f', 'attach_basic_w_en_meowth_f', 'attach_basic_w_en_oth', 'attach_basic_w_en_passimian_f', 'attach_basic_w_en_raging_bolt_f', 'attach_basic_w_en_teal_mask_og_f', 'attach_basic_w_en_wellspring_m_f', 'end', 'other', 'play_clefairy', 'play_fezandipiti', 'play_latias', 'play_mega_kangask', 'play_meowth', 'play_passimian', 'play_raging_bolt', 'play_teal_mask_og', 'play_wellspring_m', 'retreat', 'use_area_zero_', 'use_crispin', 'use_cyrano', 'use_energy_swi', 'use_glass_trum', 'use_machinatio', 'use_night_stre', 'use_orders', 'use_prime_catc', 'use_ultra_ball')
...
OPT_DIM = 28 + (1 if "optcond" in FEAT_GROUPS else 0)
