"""036_starmie_lethal — 035_starmie_replica + 007-style lethal-only search (I-074).

Base policy is byte-identical to 035 (Mega Starmie ex, reverse-engineered from
LB1300+ individual sig 491b8bfb26). On top of it, the determinized lethal-only
search from 007_lucario_lethal is grafted: MAIN choices are overridden only when
our remaining prizes are <=3 and a candidate wins the game in ALL determinization
samples. Any search failure falls back to the pure heuristic (structurally never
worse than 035).
"""
