...
デッキ: agents/195_dragapult_flg/deck.csv
ポケモン 7種 / 進化ライン 5本 / エネ 3種 / スタジアム 1種
行動クラス 65個
...
FEAT_GROUPS = {'slot_attr', 'resource', 'base', 'threat2', 'selctx', 'megaprize', 'oppseen', 'misc'}

# **このデッキの教師データで算出した削除列**（完全重複の余剰 + 定数列）。
# tools/calc_drop_cols.py が出力する JSON を --drop で渡して焼き込む。
DROP_COLS = ['act_budew', 'act_cant', 'act_dmg', 'act_dragapult', 'act_drakloak', 'act_dreepy', 'act_e', 'act_fezandipiti', 'act_fresh', 'act_hp_ratio', 'act_meowth', 'act_munkidori', 'act_n_tool', 'dis_1080', 'emax_budew', 'emax_fezandipiti', 'emax_meowth', 'hand_1080', 'hand_1246', 'hand_n_tool', 'left_1071', 'left_1080', 'left_1086', 'left_1097', 'left_112', 'left_1120', 'left_1121', 'left_1152', 'left_1182', 'left_119', 'left_1198', 'left_120', 'left_121', 'left_1213', 'left_1227', 'left_1231', 'left_1246', 'left_140', 'left_2', 'left_235', 'left_5', 'left_7', 'me_asleep', 'me_burned', 'me_dot_ability', 'me_paralyzed', 'me_poisoned', 'ms0_tool', 'ms1_tool', 'ms2_tool', 'ms3_tool', 'ms4_tool', 'ms5_tool', 'my_act_prize', 'my_has_protect', 'my_var_atk', 'n_budew', 'n_deck_me', 'n_deck_op', 'n_fezandipiti', 'n_meowth', 'n_munkidori', 'op_asleep', 'op_burned', 'op_dot_ability', 'op_paralyzed', 'op_poisoned', 'op_retreat_cost', 'opp_act_dmg', 'opp_act_energy', 'opp_act_maxdmg', 'opp_act_prize', 'opp_best_dmg_next', 'opp_cant', 'opp_seen_1081', 'opp_seen_1118', 'opp_seen_1119', 'opp_seen_1120', 'opp_seen_1123', 'opp_seen_1127', 'opp_seen_1129', 'opp_seen_1137', 'opp_seen_1147', 'opp_seen_117', 'opp_seen_1173', 'opp_seen_1175', 'opp_seen_1184', 'opp_seen_1194', 'opp_seen_120', 'opp_seen_1201', 'opp_seen_1203', 'opp_seen_121', 'opp_seen_1213', 'opp_seen_1218', 'opp_seen_1221', 'opp_seen_1223', 'opp_seen_1229', 'opp_seen_1245', 'opp_seen_1246', 'opp_seen_1251', 'opp_seen_14', 'opp_seen_18', 'opp_seen_20', 'opp_seen_235', 'opp_seen_342', 'opp_seen_343', 'opp_seen_344', 'opp_seen_345', 'opp_seen_380', 'opp_seen_381', 'opp_seen_387', 'opp_seen_66', 'opp_seen_89', 'opp_seen_90', 'opp_seen_92', 'opp_seen_93', 'os0_i_am_weak_to_it', 'os0_resist_vs_me', 'os0_weak_vs_me', 'os1_resist_vs_me', 'os2_resist_vs_me', 'os3_resist_vs_me', 'os4_resist_vs_me', 'os5_resist_vs_me', 'prz_if_my_act_ko', 'prz_if_opp_act_ko']
...
# ---- 自デッキから導出した定数 ----
SPECIES = (112, 119, 120, 121, 140, 235, 1071)
SPECIES_NAME = {112: 'munkidori', 119: 'dreepy', 120: 'drakloak', 121: 'dragapult', 140: 'fezandipiti', 235: 'budew', 1071: 'meowth'}
LINE_OF = {112: 'munkidori', 119: 'dreepy', 120: 'dreepy', 121: 'dreepy', 140: 'fezandipiti', 235: 'budew', 1071: 'meowth'}        # cardId -> 進化ライン名（最下段の種の名前）
LINE_NAMES = ('budew', 'dreepy', 'fezandipiti', 'meowth', 'munkidori')
PRE_EVO = (119, 120)        # 同デッキ内に進化先を持つ種
ENERGY_NAME = {2: 'basic_r_en', 5: 'basic_p_en', 7: 'basic_d_en'}      # 全エネ（基本+特殊）の cardId -> 短縮名
BASIC_ENERGY_NAME = {2: 'basic_r_en', 5: 'basic_p_en', 7: 'basic_d_en'}
TOOL_NAME = {}     # ポケモンに付けるツール（ATTACHで来る）
STADIUM_NAME = {1246: 'jamming_to'}
ATTACH_BUCKET = {112: 'munkidori_f', 119: 'dreepy_p', 120: 'dreepy_p', 121: 'dreepy_f', 140: 'fezandipiti_f', 235: 'budew_f', 1071: 'meowth_f'}   # エネ貼り先の種 -> クラス分類のバケット
CLS_PLAY = {112: 'play_munkidori', 119: 'play_dreepy', 120: 'play_drakloak', 121: 'play_dragapult', 140: 'play_fezandipiti', 235: 'play_budew', 1071: 'play_meowth', 1080: 'use_unfair_sta', 1086: 'use_buddy_budd', 1097: 'use_night_stre', 1120: 'use_crushing_h', 1121: 'use_ultra_ball', 1152: 'use_poké_pad', 1182: 'use_orders', 1198: 'use_crispin', 1213: 'use_judge', 1227: 'use_determinat', 1231: 'use_dawn', 1246: 'use_jamming_to'}
CLS_EVO = {120: 'evo_drakloak', 121: 'evo_dragapult'}
CLS_AB = {112: 'ab_munkidori', 119: 'ab_dreepy', 120: 'ab_drakloak', 121: 'ab_dragapult', 140: 'ab_fezandipiti', 235: 'ab_budew', 1071: 'ab_meowth', 1246: 'ab_jamming_to'}        # ポケモンの特性 + 効果を持つスタジアム
CLS_ATK = {141: 'atk_munkidori_0', 150: 'atk_dreepy_0', 151: 'atk_dreepy_1', 152: 'atk_drakloak_0', 153: 'atk_dragapult_0', 154: 'atk_dragapult_1', 183: 'atk_fezandipiti_0', 323: 'atk_budew_0', 1546: 'atk_meowth_0'}      # attackId -> クラス名（技の打ち分け）
CLASSES = ('ab_budew', 'ab_dragapult', 'ab_drakloak', 'ab_dreepy', 'ab_fezandipiti', 'ab_jamming_to', 'ab_meowth', 'ab_munkidori', 'ab_other', 'ab_stadium', 'atk_budew_0', 'atk_dragapult_0', 'atk_dragapult_1', 'atk_drakloak_0', 'atk_dreepy_0', 'atk_dreepy_1', 'atk_fezandipiti_0', 'atk_meowth_0', 'atk_munkidori_0', 'atk_other', 'attach_basic_d_en_budew_f', 'attach_basic_d_en_dreepy_f', 'attach_basic_d_en_dreepy_p', 'attach_basic_d_en_fezandipiti_f', 'attach_basic_d_en_meowth_f', 'attach_basic_d_en_munkidori_f', 'attach_basic_d_en_oth', 'attach_basic_p_en_budew_f', 'attach_basic_p_en_dreepy_f', 'attach_basic_p_en_dreepy_p', 'attach_basic_p_en_fezandipiti_f', 'attach_basic_p_en_meowth_f', 'attach_basic_p_en_munkidori_f', 'attach_basic_p_en_oth', 'attach_basic_r_en_budew_f', 'attach_basic_r_en_dreepy_f', 'attach_basic_r_en_dreepy_p', 'attach_basic_r_en_fezandipiti_f', 'attach_basic_r_en_meowth_f', 'attach_basic_r_en_munkidori_f', 'attach_basic_r_en_oth', 'end', 'evo_dragapult', 'evo_drakloak', 'other', 'play_budew', 'play_dragapult', 'play_drakloak', 'play_dreepy', 'play_fezandipiti', 'play_meowth', 'play_munkidori', 'retreat', 'use_buddy_budd', 'use_crispin', 'use_crushing_h', 'use_dawn', 'use_determinat', 'use_jamming_to', 'use_judge', 'use_night_stre', 'use_orders', 'use_poké_pad', 'use_ultra_ball', 'use_unfair_sta')
